...
#Enonse 10
diksyone1 = {"a": 1, "b": "Kalancia St Martin", "c": [1, 2], "d": "world"}
diksyone2 = {"a": 2, "b": " there", "f": [3, 4], "e": "extra"}

nouvo_diksyone = {}

for kle in set(diksyone1.keys()) | set(diksyone2.keys()):
    valye1 = diksyone1.get(kle)
    valye2 = diksyone2.get(kle)

    if isinstance(valye1, int) and isinstance(valye2, int):
